...
if __name__ == "__main__":
    ...
    parser.add_argument('--ct', type=bool, default=False, help='Train on clean examples')
    parser.add_argument('--ct_lambda', type=float, default=0.0, help='Weight of loss on clean examples')
    ...
    parser.add_argument('--wd', type=bool, default=False, help='Add weight decay')
    ...
    parser.add_argument('--clp', type=bool, default=False, help='Add CLP regularizer')
    parser.add_argument('--clp_lambda', type=float, default=0.0, help='Weight of CLP loss')
    parser.add_argument('--lsq', type=bool, default=False, help='Add LSQ regularizer')
    parser.add_argument('--lsq_lambda', type=float, default=0.0, help='Weight of LSQ loss')
